...
lio::LConsoleScreen::LConsoleScreen()
{
	// get handles
...
void lio::LConsoleScreen::Init(int width, int height, int fontw, int fonth, std::string title, short background_col)
{
	//set title
	SetTitle(title);
...
COORD lio::LConsoleScreen::GetFontSize()
{
	return m_cfi.dwFontSize;
}

void lio::LConsoleScreen::SetResolution(int width, int height)
{
	m_size = { (short)width, (short)height };
}

COORD lio::LConsoleScreen::GetResolution()
{
	return m_size;
}

void lio::LConsoleScreen::RefreshWindowSize()
{
	m_winSize = { 0, 0, (short)(m_size.X - 1), (short)(m_size.Y - 1) };
	SetConsoleWindowInfo(m_wHnd, true, &m_winSize);
}

short lio::LConsoleScreen::GetBackgroundColor()
{
	return background_col;
}

void lio::LConsoleScreen::SetBackgroundColor(short col)
{
	background_col = col;
}
...
void lio::LConsoleScreen::Fill(int x1, int y1, int x2, int y2, unsigned char c, short col)
{
	Clip(x1, y1);
	Clip(x2, y2);
	for (int x = x1; x < x2; x++)
...
void lio::LConsoleScreen::FullFill(unsigned char c, short col)
{
	Fill(0, 0, m_size.X, m_size.Y, c, col);
}

void lio::LConsoleScreen::Clear()
{
...
void lio::LConsoleScreen::Clip(int& x, int& y)
{
	if (x < 0) x = 0;
...
void lio::LConsoleScreen::DrawLine(int x1, int y1, int x2, int y2, unsigned char c, short col)
{
...
void lio::LConsoleScreen::DrawTriangle(int x1, int y1, int x2, int y2, int x3, int y3, unsigned char c, short col)
{
...
void lio::LConsoleScreen::FillTriangle(int x1, int y1, int x2, int y2, int x3, int y3, unsigned char c, short col)
{
...
void lio::LConsoleScreen::DrawCircle(int xc, int yc, int r, unsigned char c, short col)
{
	int x = 0;
	int y = r;
	int p = 3 - 2 * r;
...
void lio::LConsoleScreen::FillCircle(int xc, int yc, int r, unsigned char c, short col)
{
